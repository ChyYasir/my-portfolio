  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Yasir Rahman - Tech Enthusiast. Solving life's challenges through code. Join me in my journey of problem-solving—one line at a time."
        />
        ...
        <meta
          name="keywords"
          content="tech enthusiast, coding, problem-solving"
        />
      </Head>
            ...
            <div className="w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center">
              ...
              <div className="flex items-center self-start mt-2 lg:self-center">
                <Link
                  ...
                  text-lg font-semibold hover:bg-light hover:text-dark transition-all ease-in-out duration-300 
                ...
                <Link
                  ...
                  target="_blank"
                  className="ml-4 flex items-center bg-light text-dark p-2.5 px-6 rounded-lg 
                  text-lg font-semibold hover:bg-dark hover:text-light transition-all ease-in-out duration-300 
                  border-2 border-solid  border-dark dark:bg-dark dark:text-light
                   hover:dark:bg-light hover:dark:text-dark dark:border-light
                   md:p-2 md:px-4 md:text-base"
                >
                  Contact Me
                </Link>
