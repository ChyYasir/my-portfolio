...
const Achievement = ({ img, title, summary, teamName, rank }) => {
  return (
    <li
      className="relative col-span-1 w-full p-4 bg-light dark:bg-dark border border-solid 
    border-dark dark:border-light rounded-2xl"
    >
      ...
      <h2
        className="text-2xl font-bold capitalize text-dark/75 dark:text-light/75 hover:underline
      xs:text-lg"
      >
        {title}
      </h2>
